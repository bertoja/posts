            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  <form method="POST" action="{{ route('chirps.store')}}"> 
                    @csrf
                    <textarea class="block  w-full rounded-md border-gray-300 bg-white shadow-sm transitionr" name="message" id="" cols="30" rows="10" placeholder="Escribe lo que estas pensando"></textarea>
